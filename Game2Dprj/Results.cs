...
namespace Game2Dprj
{
    public class Results
    {
        ...
        public Results(int xScreenDimension, int yScreenDimension, GraphicsDevice graphicsDevice, Texture2D quitButtonText, Texture2D menuButtonText, Texture2D mouseMenuPointer, HittingGame hittingGame)
        {
            ...
            quitRect = new Rectangle(xScreenDimension / 3 - rectDimensions.X / 2, yScreenDimension / 2 - rectDimensions.Y / 2, rectDimensions.X, rectDimensions.Y);
